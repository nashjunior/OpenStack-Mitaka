...
function register_in_keystone
{
	. "/home/openstack/OpenStack-Ocata/ocata/controller/admin-demo/admin-openrc"
        ...
        openstack endpoint create --region RegionOne network public http://10.0.0.4:9696
        openstack endpoint create --region RegionOne network internal http://10.0.0.4:9696
        openstack endpoint create --region RegionOne network admin http://10.0.0.4:9696
